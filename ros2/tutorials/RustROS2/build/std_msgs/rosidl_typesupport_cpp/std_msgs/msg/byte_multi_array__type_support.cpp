...
static const _ByteMultiArray_type_support_symbol_names_t _ByteMultiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_msgs, msg, ByteMultiArray)),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, std_msgs, msg, ByteMultiArray)() {
  return get_message_type_support_handle<std_msgs::msg::ByteMultiArray>();
}
