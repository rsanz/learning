  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::Int8MultiArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::Int8MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::Int8MultiArray *>(
    untyped_ros_message);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Int8MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_msgs, msg, Int8MultiArray)() {
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Int8MultiArray__handle;
}
