  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::Int16MultiArray;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_std_msgs
max_serialized_size_key_Int16MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::Int16MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::Int16MultiArray *>(
    untyped_ros_message);
...
static size_t _Int16MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Int16MultiArray(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Int16MultiArray__handle;
}
