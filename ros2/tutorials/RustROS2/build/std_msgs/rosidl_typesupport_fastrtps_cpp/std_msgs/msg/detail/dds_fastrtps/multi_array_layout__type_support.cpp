...
#include "std_msgs/msg/detail/multi_array_layout__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MultiArrayDimension(
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::MultiArrayLayout;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        std_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_MultiArrayDimension(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::MultiArrayLayout *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::MultiArrayLayout *>(
    untyped_ros_message);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_MultiArrayLayout__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_msgs, msg, MultiArrayLayout)() {
  return &std_msgs::msg::typesupport_fastrtps_cpp::_MultiArrayLayout__handle;
}
