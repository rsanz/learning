...
#include "std_msgs/msg/detail/byte_multi_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::ByteMultiArray;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_std_msgs
max_serialized_size_key_ByteMultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::ByteMultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::ByteMultiArray *>(
    untyped_ros_message);
...
static size_t _ByteMultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ByteMultiArray(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_ByteMultiArray__handle;
}
