  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::Float32MultiArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::Float32MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::Float32MultiArray *>(
    untyped_ros_message);
...
static size_t _Float32MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Float32MultiArray(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Float32MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_msgs, msg, Float32MultiArray)() {
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Float32MultiArray__handle;
}
