  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::UInt8;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::UInt8 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::UInt8 *>(
    untyped_ros_message);
...
static size_t _UInt8__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UInt8(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_UInt8__handle;
}
