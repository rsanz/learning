...
bool cdr_serialize_std_msgs__msg__UInt16(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_deserialize_std_msgs__msg__UInt16(
  eprosima::fastcdr::Cdr & cdr,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_key_std_msgs__msg__UInt16(
  const std_msgs__msg__UInt16 * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: data
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t get_serialized_size_key_std_msgs__msg__UInt16(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UInt16__ros_msg_type * ros_message = static_cast<const _UInt16__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t max_serialized_size_key_std_msgs__msg__UInt16(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__UInt16 * ros_message = static_cast<const std_msgs__msg__UInt16 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__UInt16(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__UInt16 * ros_message = static_cast<std_msgs__msg__UInt16 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__UInt16(cdr, ros_message);
}
...
static size_t _UInt16__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_std_msgs__msg__UInt16(
