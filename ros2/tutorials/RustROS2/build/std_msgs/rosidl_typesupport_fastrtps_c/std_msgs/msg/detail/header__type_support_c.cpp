...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_std_msgs
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__Header * ros_message = static_cast<const std_msgs__msg__Header *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__Header(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__Header * ros_message = static_cast<std_msgs__msg__Header *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__Header(cdr, ros_message);
}
...
static size_t _Header__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__Header(
