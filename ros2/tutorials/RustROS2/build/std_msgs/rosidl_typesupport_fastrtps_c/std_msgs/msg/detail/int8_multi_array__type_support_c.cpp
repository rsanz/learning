...
#include "std_msgs/msg/detail/int8_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _Int8MultiArray__ros_msg_type = std_msgs__msg__Int8MultiArray;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__Int8MultiArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__Int8MultiArray * ros_message = static_cast<const std_msgs__msg__Int8MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__Int8MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__Int8MultiArray * ros_message = static_cast<std_msgs__msg__Int8MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__Int8MultiArray(cdr, ros_message);
}
...
static size_t _Int8MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__Int8MultiArray(
