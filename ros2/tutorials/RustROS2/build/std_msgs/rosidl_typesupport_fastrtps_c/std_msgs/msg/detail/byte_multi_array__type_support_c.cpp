...
#include "std_msgs/msg/detail/byte_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _ByteMultiArray__ros_msg_type = std_msgs__msg__ByteMultiArray;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_std_msgs__msg__ByteMultiArray(
  const std_msgs__msg__ByteMultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_deserialize_std_msgs__msg__ByteMultiArray(
  eprosima::fastcdr::Cdr & cdr,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__ByteMultiArray;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_key_std_msgs__msg__ByteMultiArray(
  const std_msgs__msg__ByteMultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t get_serialized_size_key_std_msgs__msg__ByteMultiArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ByteMultiArray__ros_msg_type * ros_message = static_cast<const _ByteMultiArray__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t max_serialized_size_key_std_msgs__msg__ByteMultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__ByteMultiArray * ros_message = static_cast<const std_msgs__msg__ByteMultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__ByteMultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__ByteMultiArray * ros_message = static_cast<std_msgs__msg__ByteMultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__ByteMultiArray(cdr, ros_message);
}

static uint32_t _ByteMultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_msgs__msg__ByteMultiArray(
      untyped_ros_message, 0));
}

static size_t _ByteMultiArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_std_msgs__msg__ByteMultiArray(
