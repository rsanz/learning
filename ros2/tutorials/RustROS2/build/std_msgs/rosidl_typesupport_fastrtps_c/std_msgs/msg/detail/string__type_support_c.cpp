...
#include "std_msgs/msg/detail/string__rosidl_typesupport_fastrtps_c.h"
...
using _String__ros_msg_type = std_msgs__msg__String;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__String;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__String * ros_message = static_cast<const std_msgs__msg__String *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__String(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__String * ros_message = static_cast<std_msgs__msg__String *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__String(cdr, ros_message);
}
...
static size_t _String__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__String(
