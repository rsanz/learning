  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__UInt8MultiArray * ros_message = static_cast<const std_msgs__msg__UInt8MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__UInt8MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__UInt8MultiArray * ros_message = static_cast<std_msgs__msg__UInt8MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__UInt8MultiArray(cdr, ros_message);
}

static uint32_t _UInt8MultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_msgs__msg__UInt8MultiArray(
      untyped_ros_message, 0));
}

static size_t _UInt8MultiArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_std_msgs__msg__UInt8MultiArray(
