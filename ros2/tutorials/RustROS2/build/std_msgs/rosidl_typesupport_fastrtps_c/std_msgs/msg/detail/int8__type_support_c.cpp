...
bool cdr_serialize_std_msgs__msg__Int8(
  const std_msgs__msg__Int8 * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_deserialize_std_msgs__msg__Int8(
  eprosima::fastcdr::Cdr & cdr,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__Int8;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_key_std_msgs__msg__Int8(
  const std_msgs__msg__Int8 * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: data
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t get_serialized_size_key_std_msgs__msg__Int8(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Int8__ros_msg_type * ros_message = static_cast<const _Int8__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t max_serialized_size_key_std_msgs__msg__Int8(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__Int8 * ros_message = static_cast<const std_msgs__msg__Int8 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__Int8(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__Int8 * ros_message = static_cast<std_msgs__msg__Int8 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__Int8(cdr, ros_message);
}
...
static size_t _Int8__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__Int8(
