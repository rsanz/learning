...
#include "std_msgs/msg/detail/multi_array_layout__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/multi_array_dimension__functions.h"  // dim
...
using _MultiArrayLayout__ros_msg_type = std_msgs__msg__MultiArrayLayout;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: dim
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_std_msgs__msg__MultiArrayDimension(
        &array_ptr[i], cdr);
    }
  }
  ...
  std_msgs__msg__MultiArrayLayout * ros_message)
{
  // Field name: dim
  {
    ...
    if (ros_message->dim.data) {
      std_msgs__msg__MultiArrayDimension__Sequence__fini(&ros_message->dim);
    }
    ...
    auto array_ptr = ros_message->dim.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_std_msgs__msg__MultiArrayDimension(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_std_msgs__msg__MultiArrayDimension(
  ...
  size_t current_alignment)
{
  ...
  // Field name: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_std_msgs__msg__MultiArrayDimension(
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__MultiArrayLayout;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: dim
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_std_msgs__msg__MultiArrayDimension(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: dim
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_std_msgs__msg__MultiArrayDimension(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_std_msgs__msg__MultiArrayDimension(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__MultiArrayLayout * ros_message = static_cast<const std_msgs__msg__MultiArrayLayout *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__MultiArrayLayout(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__MultiArrayLayout * ros_message = static_cast<std_msgs__msg__MultiArrayLayout *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__MultiArrayLayout(cdr, ros_message);
}

static uint32_t _MultiArrayLayout__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_msgs__msg__MultiArrayLayout(
...
static size_t _MultiArrayLayout__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__MultiArrayLayout(
