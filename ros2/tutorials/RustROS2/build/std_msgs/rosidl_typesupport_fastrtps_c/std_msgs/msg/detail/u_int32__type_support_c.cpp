...
#include "std_msgs/msg/detail/u_int32__rosidl_typesupport_fastrtps_c.h"
...
using _UInt32__ros_msg_type = std_msgs__msg__UInt32;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__UInt32;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__UInt32 * ros_message = static_cast<const std_msgs__msg__UInt32 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__UInt32(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__UInt32 * ros_message = static_cast<std_msgs__msg__UInt32 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__UInt32(cdr, ros_message);
}

static uint32_t _UInt32__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_msgs__msg__UInt32(
...
static size_t _UInt32__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__UInt32(
