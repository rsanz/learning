...
#include "std_msgs/msg/detail/u_int64_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _UInt64MultiArray__ros_msg_type = std_msgs__msg__UInt64MultiArray;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_std_msgs__msg__UInt64MultiArray(
  const std_msgs__msg__UInt64MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_deserialize_std_msgs__msg__UInt64MultiArray(
  eprosima::fastcdr::Cdr & cdr,
  std_msgs__msg__UInt64MultiArray * ros_message)
{
  ...
  // Field name: data
  {
    ...
    if (ros_message->data.data) {
      rosidl_runtime_c__uint64__Sequence__fini(&ros_message->data);
    }
    if (!rosidl_runtime_c__uint64__Sequence__init(&ros_message->data, size)) {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__UInt64MultiArray;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_key_std_msgs__msg__UInt64MultiArray(
  const std_msgs__msg__UInt64MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t get_serialized_size_key_std_msgs__msg__UInt64MultiArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UInt64MultiArray__ros_msg_type * ros_message = static_cast<const _UInt64MultiArray__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t max_serialized_size_key_std_msgs__msg__UInt64MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__UInt64MultiArray * ros_message = static_cast<const std_msgs__msg__UInt64MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__UInt64MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__UInt64MultiArray * ros_message = static_cast<std_msgs__msg__UInt64MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__UInt64MultiArray(cdr, ros_message);
}
...
static size_t _UInt64MultiArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_std_msgs__msg__UInt64MultiArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, std_msgs, msg, UInt64MultiArray)() {
