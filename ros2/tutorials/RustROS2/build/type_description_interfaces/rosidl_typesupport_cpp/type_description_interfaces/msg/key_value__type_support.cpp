...
static const _KeyValue_type_support_symbol_names_t _KeyValue_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, type_description_interfaces, msg, KeyValue)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, type_description_interfaces, msg, KeyValue)),
  }
};
...
{
  return &::type_description_interfaces::msg::rosidl_typesupport_cpp::KeyValue_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, type_description_interfaces, msg, KeyValue)() {
  return get_message_type_support_handle<type_description_interfaces::msg::KeyValue>();
}
