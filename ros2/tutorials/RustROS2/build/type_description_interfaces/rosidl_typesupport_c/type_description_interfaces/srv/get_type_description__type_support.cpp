...
static const _GetTypeDescription_Request_type_support_symbol_names_t _GetTypeDescription_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, type_description_interfaces, srv, GetTypeDescription_Request)),
...
static const _GetTypeDescription_Response_type_support_symbol_names_t _GetTypeDescription_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, type_description_interfaces, srv, GetTypeDescription_Response)),
...
static const _GetTypeDescription_Event_type_support_symbol_names_t _GetTypeDescription_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, type_description_interfaces, srv, GetTypeDescription_Event)),
...
static const _GetTypeDescription_type_support_symbol_names_t _GetTypeDescription_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, type_description_interfaces, srv, GetTypeDescription)),
