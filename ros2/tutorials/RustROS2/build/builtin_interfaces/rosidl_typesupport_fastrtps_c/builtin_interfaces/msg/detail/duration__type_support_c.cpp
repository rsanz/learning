...
#include "builtin_interfaces/msg/detail/duration__rosidl_typesupport_fastrtps_c.h"
...
using _Duration__ros_msg_type = builtin_interfaces__msg__Duration;
...
{
  const _Duration__ros_msg_type * ros_message = static_cast<const _Duration__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = builtin_interfaces__msg__Duration;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const builtin_interfaces__msg__Duration * ros_message = static_cast<const builtin_interfaces__msg__Duration *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_builtin_interfaces__msg__Duration(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  builtin_interfaces__msg__Duration * ros_message = static_cast<builtin_interfaces__msg__Duration *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_builtin_interfaces__msg__Duration(cdr, ros_message);
}

static uint32_t _Duration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_builtin_interfaces__msg__Duration(
...
static size_t _Duration__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_builtin_interfaces__msg__Duration(
...
static message_type_support_callbacks_t __callbacks_Duration = {
