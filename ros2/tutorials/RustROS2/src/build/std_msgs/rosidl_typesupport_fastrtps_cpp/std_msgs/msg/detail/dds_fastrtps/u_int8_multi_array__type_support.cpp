...
{
  auto typed_message =
    static_cast<const std_msgs::msg::UInt8MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::UInt8MultiArray *>(
    untyped_ros_message);
...
static size_t _UInt8MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UInt8MultiArray(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_UInt8MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_msgs, msg, UInt8MultiArray)() {
  return &std_msgs::msg::typesupport_fastrtps_cpp::_UInt8MultiArray__handle;
}
