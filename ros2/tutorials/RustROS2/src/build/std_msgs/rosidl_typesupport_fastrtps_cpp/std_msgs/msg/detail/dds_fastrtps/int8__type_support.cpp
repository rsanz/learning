  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::Int8;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::Int8 *>(
    untyped_ros_message);
...
static size_t _Int8__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Int8(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Int8__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_msgs, msg, Int8)() {
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Int8__handle;
}
