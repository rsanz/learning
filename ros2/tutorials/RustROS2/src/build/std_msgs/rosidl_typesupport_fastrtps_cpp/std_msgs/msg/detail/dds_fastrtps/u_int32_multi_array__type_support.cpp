  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::UInt32MultiArray;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_std_msgs
max_serialized_size_key_UInt32MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::UInt32MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::UInt32MultiArray *>(
    untyped_ros_message);
...
static size_t _UInt32MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UInt32MultiArray(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_UInt32MultiArray__handle;
}
