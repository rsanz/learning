...
#include "std_msgs/msg/detail/u_int16_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _UInt16MultiArray__ros_msg_type = std_msgs__msg__UInt16MultiArray;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_std_msgs__msg__UInt16MultiArray(
  const std_msgs__msg__UInt16MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_deserialize_std_msgs__msg__UInt16MultiArray(
  eprosima::fastcdr::Cdr & cdr,
  std_msgs__msg__UInt16MultiArray * ros_message)
{
  // Field name: layout
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__UInt16MultiArray;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_key_std_msgs__msg__UInt16MultiArray(
  const std_msgs__msg__UInt16MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t get_serialized_size_key_std_msgs__msg__UInt16MultiArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UInt16MultiArray__ros_msg_type * ros_message = static_cast<const _UInt16MultiArray__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t max_serialized_size_key_std_msgs__msg__UInt16MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__UInt16MultiArray * ros_message = static_cast<const std_msgs__msg__UInt16MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__UInt16MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__UInt16MultiArray * ros_message = static_cast<std_msgs__msg__UInt16MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__UInt16MultiArray(cdr, ros_message);
}

static uint32_t _UInt16MultiArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_msgs__msg__UInt16MultiArray(
...
static size_t _UInt16MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__UInt16MultiArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, std_msgs, msg, UInt16MultiArray)() {
