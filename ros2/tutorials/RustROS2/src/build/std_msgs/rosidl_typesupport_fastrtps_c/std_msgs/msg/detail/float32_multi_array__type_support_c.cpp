...
#include "std_msgs/msg/detail/float32_multi_array__rosidl_typesupport_fastrtps_c.h"
...
using _Float32MultiArray__ros_msg_type = std_msgs__msg__Float32MultiArray;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__Float32MultiArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__Float32MultiArray * ros_message = static_cast<const std_msgs__msg__Float32MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__Float32MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__Float32MultiArray * ros_message = static_cast<std_msgs__msg__Float32MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__Float32MultiArray(cdr, ros_message);
}
...
static size_t _Float32MultiArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_std_msgs__msg__Float32MultiArray(
