  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__ColorRGBA * ros_message = static_cast<const std_msgs__msg__ColorRGBA *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__ColorRGBA(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__ColorRGBA * ros_message = static_cast<std_msgs__msg__ColorRGBA *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__ColorRGBA(cdr, ros_message);
}
