...
#include "std_msgs/msg/detail/empty__rosidl_typesupport_fastrtps_c.h"
...
using _Empty__ros_msg_type = std_msgs__msg__Empty;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__Empty;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__Empty * ros_message = static_cast<const std_msgs__msg__Empty *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__Empty(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__Empty * ros_message = static_cast<std_msgs__msg__Empty *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__Empty(cdr, ros_message);
}

static uint32_t _Empty__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_msgs__msg__Empty(
...
static size_t _Empty__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__Empty(
