  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__Int64 * ros_message = static_cast<const std_msgs__msg__Int64 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__Int64(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__Int64 * ros_message = static_cast<std_msgs__msg__Int64 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__Int64(cdr, ros_message);
}

static uint32_t _Int64__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_msgs__msg__Int64(
...
static size_t _Int64__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__Int64(
