  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const action_msgs__msg__GoalStatus * ros_message = static_cast<const action_msgs__msg__GoalStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_action_msgs__msg__GoalStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  action_msgs__msg__GoalStatus * ros_message = static_cast<action_msgs__msg__GoalStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_action_msgs__msg__GoalStatus(cdr, ros_message);
}
