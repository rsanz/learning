...
: ${AMENT_CURRENT_PREFIX:="/home/rsanz/git/learning/ros2/tutorials/RustROS2/src/install/rosidl_core_generators"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosidl_core_generators/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rosidl_core_generators/environment/path.sh"
