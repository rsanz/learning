  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const unique_identifier_msgs__msg__UUID * ros_message = static_cast<const unique_identifier_msgs__msg__UUID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_unique_identifier_msgs__msg__UUID(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  unique_identifier_msgs__msg__UUID * ros_message = static_cast<unique_identifier_msgs__msg__UUID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_unique_identifier_msgs__msg__UUID(cdr, ros_message);
}
