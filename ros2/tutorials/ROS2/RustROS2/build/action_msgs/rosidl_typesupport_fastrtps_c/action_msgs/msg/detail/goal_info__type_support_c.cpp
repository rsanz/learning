  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const action_msgs__msg__GoalInfo * ros_message = static_cast<const action_msgs__msg__GoalInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_action_msgs__msg__GoalInfo(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  action_msgs__msg__GoalInfo * ros_message = static_cast<action_msgs__msg__GoalInfo *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_action_msgs__msg__GoalInfo(cdr, ros_message);
}

static uint32_t _GoalInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_action_msgs__msg__GoalInfo(
      untyped_ros_message, 0));
}

static size_t _GoalInfo__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_action_msgs__msg__GoalInfo(
