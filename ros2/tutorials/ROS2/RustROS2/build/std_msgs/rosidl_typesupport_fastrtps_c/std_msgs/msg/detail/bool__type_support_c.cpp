...
#include "std_msgs/msg/detail/bool__rosidl_typesupport_fastrtps_c.h"
...
using _Bool__ros_msg_type = std_msgs__msg__Bool;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__Bool;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__Bool * ros_message = static_cast<const std_msgs__msg__Bool *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__Bool(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__Bool * ros_message = static_cast<std_msgs__msg__Bool *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__Bool(cdr, ros_message);
}

static uint32_t _Bool__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_std_msgs__msg__Bool(
...
static size_t _Bool__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_std_msgs__msg__Bool(
