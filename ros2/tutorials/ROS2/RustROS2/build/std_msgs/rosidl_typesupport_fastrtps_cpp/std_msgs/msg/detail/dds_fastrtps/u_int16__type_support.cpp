  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::UInt16;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_std_msgs
max_serialized_size_key_UInt16(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::UInt16 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::UInt16 *>(
    untyped_ros_message);
...
static size_t _UInt16__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UInt16(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_UInt16__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_msgs, msg, UInt16)() {
  return &std_msgs::msg::typesupport_fastrtps_cpp::_UInt16__handle;
}
