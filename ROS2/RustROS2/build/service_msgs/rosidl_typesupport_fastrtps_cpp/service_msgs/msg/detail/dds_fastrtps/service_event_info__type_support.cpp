...
static size_t _ServiceEventInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ServiceEventInfo(full_bounded, is_plain, 0);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_service_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<service_msgs::msg::ServiceEventInfo>()
{
  return &service_msgs::msg::typesupport_fastrtps_cpp::_ServiceEventInfo__handle;
}
