...
#include "unique_identifier_msgs/msg/detail/uuid__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: uuid
  {
    ...
    size_t item_size = sizeof(ros_message.uuid[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = unique_identifier_msgs::msg::UUID;
    is_plain =
      (
...
static size_t _UUID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UUID(full_bounded, is_plain, 0);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_unique_identifier_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<unique_identifier_msgs::msg::UUID>()
{
  return &unique_identifier_msgs::msg::typesupport_fastrtps_cpp::_UUID__handle;
}
