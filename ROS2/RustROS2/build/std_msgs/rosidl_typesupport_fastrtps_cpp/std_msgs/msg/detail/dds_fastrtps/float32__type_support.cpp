  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::Float32;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::Float32 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::Float32 *>(
    untyped_ros_message);
...
static size_t _Float32__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Float32(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Float32__handle;
}
