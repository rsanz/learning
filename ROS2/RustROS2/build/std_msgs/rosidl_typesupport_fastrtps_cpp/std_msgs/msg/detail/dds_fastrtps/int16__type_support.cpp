  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::Int16;
    is_plain =
      (
...
static size_t _Int16__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Int16(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Int16__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, std_msgs, msg, Int16)() {
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Int16__handle;
}
