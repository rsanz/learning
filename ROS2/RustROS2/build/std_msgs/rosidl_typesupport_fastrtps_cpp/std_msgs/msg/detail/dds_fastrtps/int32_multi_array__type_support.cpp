  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs::msg::Int32MultiArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const std_msgs::msg::Int32MultiArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<std_msgs::msg::Int32MultiArray *>(
    untyped_ros_message);
...
static size_t _Int32MultiArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Int32MultiArray(full_bounded, is_plain, 0);
...
{
  return &std_msgs::msg::typesupport_fastrtps_cpp::_Int32MultiArray__handle;
}
