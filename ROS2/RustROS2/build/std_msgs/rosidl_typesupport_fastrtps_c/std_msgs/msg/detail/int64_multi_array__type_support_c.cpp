...
bool cdr_serialize_std_msgs__msg__Int64MultiArray(
  const std_msgs__msg__Int64MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_deserialize_std_msgs__msg__Int64MultiArray(
  eprosima::fastcdr::Cdr & cdr,
  std_msgs__msg__Int64MultiArray * ros_message)
{
  // Field name: layout
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = std_msgs__msg__Int64MultiArray;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
bool cdr_serialize_key_std_msgs__msg__Int64MultiArray(
  const std_msgs__msg__Int64MultiArray * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: layout
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t get_serialized_size_key_std_msgs__msg__Int64MultiArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Int64MultiArray__ros_msg_type * ros_message = static_cast<const _Int64MultiArray__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_std_msgs
size_t max_serialized_size_key_std_msgs__msg__Int64MultiArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const std_msgs__msg__Int64MultiArray * ros_message = static_cast<const std_msgs__msg__Int64MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_std_msgs__msg__Int64MultiArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  std_msgs__msg__Int64MultiArray * ros_message = static_cast<std_msgs__msg__Int64MultiArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_std_msgs__msg__Int64MultiArray(cdr, ros_message);
}
...
static size_t _Int64MultiArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_std_msgs__msg__Int64MultiArray(
